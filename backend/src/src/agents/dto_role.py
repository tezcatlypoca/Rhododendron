...
class RoleDTO:
    ...
    def __str__(self):
        return f"ManagerDTO(name={self.name}, description={self.description})"
# END CLASS

@dataclass
class ManagerDTO(RoleDTO):
    def __init__(self):
        super().__init__(
            name="Manager",
            description="Responsable de la planification et de la coordination du projet",
            prompt_system="""Tu es un Manager de projet logiciel expérimenté. Ton rôle est de :
...
@dataclass
class DeveloperDTO(RoleDTO):
    def __init__(self):
        super().__init__(
            name="Developer",
            description="Responsable de la conception et de l'implémentation du code",
...
@dataclass
class TesterDTO(RoleDTO):
    def __init__(self):
        super().__init__(
            name="Tester",
            description="Responsable de l'assurance qualité et des tests",
...
@dataclass
class CommercialDTO(RoleDTO):
    def __init__(self):
        super().__init__(
            name="Commercial",
            description="Responsable de la relation client et des aspects commerciaux",
...
@dataclass
class ScrumMasterDTO(RoleDTO):
    def __init__(self):
        super().__init__(
            name="ScrumMaster",
            description="Responsable de la facilitation de la méthodologie Scrum",
